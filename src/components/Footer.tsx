      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          >
            ...
            <p className="text-body-sm text-background/60 max-w-xs">
              Dedicated virtual medical assistants connecting Filipino healthcare talent with US practices.
            </p>
          </motion.div>
        ...
        <motion.div
          ...
          className="pt-8 border-t border-background/10 flex flex-col sm:flex-row justify-between items-center gap-4"
        >
          <p className="text-body-sm text-background/40">
            © {new Date().getFullYear()} VMACare. All rights reserved.
          </p>
          <p className="text-body-sm text-background/40">
